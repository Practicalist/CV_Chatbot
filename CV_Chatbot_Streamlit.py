...
responses = {
    ...
    ("this chatbot", "the chatbot", "a chatbot", "chat bot", "make this", "made this", "this chat bot", "the chat bot", "a chat bot", "cv chatbot"): "This chatbot began as an idea for an interactive CV to showcase my skills in an innovative way. I initially considered using a chatbot service but wanted a more customized approach, so I decided to develop it myself with Python. After exploring options like Chatterbot, which wasn’t compatible, I worked with ChatGPT to implement a keyword-based approach that best fit my needs. Using my CV as a foundation, I created prompts and refined them based on past interview experiences. This project demonstrates my initiative and adaptability—I’d be glad to share more details!",
